package com.example.a1_akhilboda_34396268_fit2081.model
...
@Database(entities = [UserEntity::class, FoodIntakeEntity::class, NutriCoachTipEntity::class], version = 1, exportSchema = false)
